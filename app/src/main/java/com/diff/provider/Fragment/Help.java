...
public class Help extends Fragment implements View.OnClickListener {
    ...
    public void findViewByIdAndInitialize(View view) {
        ...
        title_txt.setText("Diffride" + " " + getString(R.string.help));
    }
...
//                startActivity(Intent.createChooser(intent, "Send Email"));
            ...
            case R.id.img_phone:
                ...
                break;
            case R.id.img_web:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.diff.com.my/"));
    ...
    public void GoToBeginActivity() {
        ...
        if (AccessDetails.demo_build) {
            goToLogin = new Intent(getContext(), AccessKeyActivity.class);
        } else {

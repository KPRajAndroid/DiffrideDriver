...
import com.diff.provider.Bean.Connect;
import com.diff.provider.Fragment.EarningsFragment;
import com.diff.provider.Fragment.Help;
import com.diff.provider.Fragment.Map;
import com.diff.provider.Fragment.SummaryFragment;
...
public class MainActivity extends AppCompatActivity implements Map.ServiceFlowFgmtListener {
...
//                .into(imgProfile);
        ...
        if (SharedHelper.getKey(context,"gender").equalsIgnoreCase("male")){
            Utilities.loadImage(SharedHelper.getKey(context, "picture"), imgProfile,R.drawable.user_placeholder);
        }else {
            Utilities.loadImage(SharedHelper.getKey(context, "picture"), imgProfile,R.drawable.user_placeholder_f);
        }

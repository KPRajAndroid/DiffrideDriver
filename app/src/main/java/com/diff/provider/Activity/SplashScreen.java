...
import com.diff.provider.BuildConfig;
import com.diff.provider.FCM.ForceUpdateChecker;
...
public class SplashScreen extends AppCompatActivity implements ForceUpdateChecker.OnUpdateNeededListener {
    ...
    public void accessKeyAPI() {
        ...
        jsonObjectRequest.setRetryPolicy(new DefaultRetryPolicy(60 * 2000, 0, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));

package com.diff.provider.Helper;
...
public class URLHelper {
    ...
    public static final String GET_DOC = "/api/provider/document/types";
    public static final String UPDATE_DOC = "/api/provider/profile/documentupload";
    public static final String NOTIFICATION_LIST = "/api/provider/promocode/list";
    public static final String WALLET_ADD = "/api/provider/molpay/return";
    public static final String CREDIT_ADD = "/api/provider/credit/add";

    public static final String SERVICE_TYPE ="/api/provider/service_type";
    public static final String DOCUMNETS_LIST ="/api/provider/document/list";


    public static final String COUPON_ADD = "/api/provider/free/credit";
    public static final String TERMS = "http://stage.diff.com.my/terms";
